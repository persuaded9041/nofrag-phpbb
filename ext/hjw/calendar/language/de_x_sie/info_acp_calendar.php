...
$lang = array_merge($lang, array(
	...
	'ACP_CALENDAR_APPOINTMENT_LIST_TEXT'	=> 'Die hier angelegten Termine werden in der angelegten Farbe im Kalender angezeigt.</p><p>Wenn das Datum mit der Jahreszahl angegeben wird, erfolgt die Anzeige nur in dem betreffenden Jahr. Es sei denn, man hat ein Häkchen bei Jahrestag gemacht. Dann erfolgt die Anzeige jedes Jahr mit der Anzahl der vergangenen Jahre.</p><p>Bei Angabe ohne Jahreszahl wird der Termin jedes Jahr gezeigt.',
	...
	'ACP_CALENDAR_DATE_FROM'				=> 'Von/Am',
	'ACP_CALENDAR_DATE_TO'					=> 'Bis',
	...
	'ACP_CALENDAR_EVENT_SETTINGS_TEXT'		=> 'Die den entsprechenden Typen zugeordneten Veranstaltungen werden in den  entsprechenden Farben und in der hier gezeigten Reihenfolge im Kalender angezeigt.',
	'ACP_CALENDAR_EVENTS'					=> 'Veranstaltungen',
	'ACP_FOOTBALL_ON_CALENDAR'				=> 'Fußballspiele im Kalender anzeigen?',
	'ACP_CALENDAR_ON_INDEX_OFF'				=> 'Übersicht/Termine in Kopfzeile für den aktuellen Tag abschaltbar?',
	...
	'ACP_CALENDAR_INSTRUCTIONS_TEXT_1'		=> 'Es gibt zwei Möglichkeiten Kalendereinträge anzulegen.</p><p>Wenn in dem entsprechende Forum die Termineingabe erlaubt ist und mindestens ein Veranstaltungstyp erstellt ist, gibt es über dem Beitragsformular eine Zeile, in die die entsprechenden Einträge gemacht werden können. Der Name wird im Kalender angezeigt und sollte nicht zu lang gewählt werden. Der Betreff des Beitrages wird angezeigt, wenn man mit dem Cursor im Kalender auf den Namen zeigt. Da kann man dann zusätzliche Informationen geben. Beim Klick auf den Namen wird der Beitrag aufgerufen. Die Eingabe des Bis-Datums ist optional für mehrtägige Veranstaltungen.</p><p>Falls der Veranstaltungstyp mit Teilnehmerliste angelegt ist, ist diese nach Absendung des Beitrages in der viewtopic.php zu sehen. Teilnehmerlisten werden Gästen und Bots nicht gezeigt.</p><p>Im Kalender werden nur Termine aus Foren angezeigt bei denen der Betrachter Leserecht hat.</p><p>Die zweite Möglichkeit Termine anzulegen, ist die Terminliste hier im ACP. Dort lassen sich auch Termine mit Link auf andere Seiten anlegen.',
	...
	'ACP_CALENDAR_SPECIAL_DAYS_TEXT'		=> 'Bewegliche Feiertage werden nach dem Ostersonntag berechnet.</p><p>Die Tage bis Ostern werden negativ eingegeben.',
	...
	'ACP_CALENDAR_NO_YEAR'					=> 'Keine Jahreszahl',
	...
	'ACP_CALENDAR_DATE_FORMAT'				=> 'Datumsformat bei der Eingabe',
	'ACP_CALENDAR_DISPLAY_TIME'				=> 'Kalendereingabe mit Uhrzeit?',
	'ACP_CALENDAR_WEEK_ON_PHONE'			=> 'Wochenübersicht auf Smartphone anzeigen?',
	'ACP_CALENDAR_NEXT_ON_PHONE'			=> 'Nächste Termine auf Smartphone anzeigen?',
	'ACP_BIRTHDAY_ON_NEXT'					=> 'Geburtstage als nächste Termine anzeigen?',
	'ACP_CALENDAR_WITHOUT'					=> 'ohne',
));
