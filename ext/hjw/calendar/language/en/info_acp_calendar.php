...
$lang = array_merge($lang, array(
	...
	'ACP_CALENDAR_APPOINTMENT_LIST_TEXT'	=> 'The created dates will be displayed in the specified color on the calendar.</p><p>If the date is specified with the year, the appointment is displayed only in the year in question. Unless you make a checkmark for anniversary. Then the Date will be displayed each year with the number of past years.</p><p>If you specify without year the date is shown every year.',
	...
	'ACP_CALENDAR_DATE_FROM'				=> 'From',
	'ACP_CALENDAR_DATE_TO'					=> 'To',
	'ACP_CALENDAR_DISPLAYOPTIONS'			=> 'Display Options',
	'ACP_CALENDAR_EASTER_DAYS'				=> 'The Days befor resp. after Easter',
	...
	'ACP_CALENDAR_EVENT_SETTINGS_TEXT'		=> 'The corresponding types associated events will in the appropriate colors and in the order shown here displayed on the calendar.',
	...
	'ACP_CALENDAR_INSTRUCTIONS_TEXT_1'		=> 'There are two ways to create calendar entries.</p><p>If in the appropriate forum the calendar entry is allowed and at least one event type was created, there are over the posting-box input fields in which the corresponding entries can be made. The name appears in the calendar and should not be too long. The Post subject appears when you point the cursor in the calendar on the name. There you can provide additional information. A click on an event on the calendar calls the descriptive topic. The input of the to-date is optional for multi-day events.</p><p>If the event type was created with participant-list, is to see this after sending the contribution in the viewtopic.php. Participants lists will guests and bots not displayed.</p><p>Only calendar dates from forums are displayed, in which the viewer has permission to read.</p>The second way to create calendar entries, is the event list here in the ACP. There you can also create appointments with link to other pages.',
	...
	'ACP_CALENDAR_SPECIAL_DAYS_TEXT'		=> 'Moving holidays are based on the Easter Sunday.</p><p>The days until Easter will entered negative.',
	...
	'ACP_CALENDAR_DATE_FORMAT'				=> 'Date format for input',
	'ACP_CALENDAR_DISPLAY_TIME'				=> 'Calendar input with time?',
	'ACP_CALENDAR_WEEK_ON_PHONE'			=> 'Show weekly overview on Smartphone?',
	'ACP_CALENDAR_NEXT_ON_PHONE'			=> 'Show next events on Smartphone?',
	'ACP_BIRTHDAY_ON_NEXT'					=> 'Show birthdays as next events?',
