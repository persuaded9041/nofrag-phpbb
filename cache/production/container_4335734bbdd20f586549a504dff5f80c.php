...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'alfredoramos.simplespoiler.helper' => 'getAlfredoramos_Simplespoiler_HelperService',
            'alfredoramos.simplespoiler.listener' => 'getAlfredoramos_Simplespoiler_ListenerService',
            ...
            'david63.privacypolicy.acp.data.controller' => 'getDavid63_Privacypolicy_Acp_Data_ControllerService',
            'david63.privacypolicy.acp.edit.controller' => 'getDavid63_Privacypolicy_Acp_Edit_ControllerService',
            'david63.privacypolicy.acp.manage.controller' => 'getDavid63_Privacypolicy_Acp_Manage_ControllerService',
            'david63.privacypolicy.autogroups.type.ppaccept' => 'getDavid63_Privacypolicy_Autogroups_Type_PpacceptService',
            'david63.privacypolicy.core.functions' => 'getDavid63_Privacypolicy_Core_FunctionsService',
            'david63.privacypolicy.core.privacypolicy' => 'getDavid63_Privacypolicy_Core_PrivacypolicyService',
            'david63.privacypolicy.core.privacypolicy_lang' => 'getDavid63_Privacypolicy_Core_PrivacypolicyLangService',
            'david63.privacypolicy.listener' => 'getDavid63_Privacypolicy_ListenerService',
            'david63.privacypolicy.main.controller' => 'getDavid63_Privacypolicy_Main_ControllerService',
            'david63.privacypolicy.ucp.controller' => 'getDavid63_Privacypolicy_Ucp_ControllerService',
            ...
            'ger.feedpostbot.classes.driver' => 'getGer_Feedpostbot_Classes_DriverService',
            'ger.feedpostbot.cron.task.feedpostbot_cron' => 'getGer_Feedpostbot_Cron_Task_FeedpostbotCronService',
            ...
            'hifikabin.amazonaffiliate.listener' => 'getHifikabin_Amazonaffiliate_ListenerService',
            'hjw.calendar.controller' => 'getHjw_Calendar_ControllerService',
            'hjw.calendar.listener' => 'getHjw_Calendar_ListenerService',
            'hook_finder' => 'getHookFinderService',
            'http_kernel' => 'getHttpKernelService',
            'javiexin.chgposttime.listener' => 'getJaviexin_Chgposttime_ListenerService',
            'jv.deletemyregistration.listener' => 'getJv_Deletemyregistration_ListenerService',
            ...
            'paul999.ajaxshoutbox.controller' => 'getPaul999_Ajaxshoutbox_ControllerService',
            'paul999.ajaxshoutbox.cron.task.shoutbox_prune' => 'getPaul999_Ajaxshoutbox_Cron_Task_ShoutboxPruneService',
            'paul999.ajaxshoutbox.delete' => 'getPaul999_Ajaxshoutbox_DeleteService',
            'paul999.ajaxshoutbox.listener' => 'getPaul999_Ajaxshoutbox_ListenerService',
    ...
    /**
     * Gets the public 'alfredoramos.simplespoiler.helper' shared service.
     *
     * @return \alfredoramos\simplespoiler\includes\helper
     */
    protected function getAlfredoramos_Simplespoiler_HelperService()
    {
        return $this->services['alfredoramos.simplespoiler.helper'] = new \alfredoramos\simplespoiler\includes\helper($this->get('dbal.conn'), $this->get('filesystem'), $this->get('language'), $this->get('template'), $this->get('config'), $this->get('text_formatter.s9e.parser'), $this->get('text_formatter.s9e.utils'), './', 'php');
    }

    /**
     * Gets the public 'alfredoramos.simplespoiler.listener' shared service.
     *
     * @return \alfredoramos\simplespoiler\event\listener
     */
    protected function getAlfredoramos_Simplespoiler_ListenerService()
    {
        return $this->services['alfredoramos.simplespoiler.listener'] = new \alfredoramos\simplespoiler\event\listener($this->get('alfredoramos.simplespoiler.helper'));
    }
    ...
    protected function getCron_TaskCollectionService()
    {
        ...
        $instance->add('ger.feedpostbot.cron.task.feedpostbot_cron');
        $instance->add('paul999.ajaxshoutbox.cron.task.shoutbox_prune');
    ...
    /**
     * Gets the public 'david63.privacypolicy.acp.data.controller' shared service.
     *
     * @return \david63\privacypolicy\controller\acp_data_controller
     */
    protected function getDavid63_Privacypolicy_Acp_Data_ControllerService()
    {
        return $this->services['david63.privacypolicy.acp.data.controller'] = new \david63\privacypolicy\controller\acp_data_controller($this->get('config'), $this->get('request'), $this->get('user'), $this->get('template'), $this->get('language'), $this->get('dbal.conn'), './', 'php', $this->get('david63.privacypolicy.core.privacypolicy'), $this->get('pagination'), $this->get('log'), $this->get('david63.privacypolicy.core.functions'), array('acl_groups' => 'phpbb_acl_groups', 'acl_options' => 'phpbb_acl_options', 'acl_roles_data' => 'phpbb_acl_roles_data', 'acl_roles' => 'phpbb_acl_roles', 'acl_users' => 'phpbb_acl_users', 'attachments' => 'phpbb_attachments', 'banlist' => 'phpbb_banlist', 'bbcodes' => 'phpbb_bbcodes', 'bookmarks' => 'phpbb_bookmarks', 'bots' => 'phpbb_bots', 'config' => 'phpbb_config', 'config_text' => 'phpbb_config_text', 'confirm' => 'phpbb_confirm', 'disallow' => 'phpbb_disallow', 'drafts' => 'phpbb_drafts', 'ext' => 'phpbb_ext', 'extesnions' => 'phpbb_extesnions', 'extension_groups\'' => 'phpbb_extension_groups', 'forums' => 'phpbb_forums', 'forums_access' => 'phpbb_forums_access', 'forums_track' => 'phpbb_forums_track', 'forums_watch' => 'phpbb_forums_watch', 'groups' => 'phpbb_groups', 'icons' => 'phpbb_icons', 'lang' => 'phpbb_lang', 'log' => 'phpbb_log', 'login_attempts' => 'phpbb_login_attempts', 'migrations' => 'phpbb_migrations', 'moderator_cache' => 'phpbb_moderator_cache', 'modules' => 'phpbb_modules', 'notification_types' => 'phpbb_notification_types', 'notifications' => 'phpbb_notifications', 'poll_options' => 'phpbb_poll_options', 'poll_votes' => 'phpbb_poll_votes', 'posts' => 'phpbb_posts', 'privmsgs' => 'phpbb_privmsgs', 'privmsgs_folder' => 'phpbb_privmsgs_folder', 'privmsgs_rules' => 'phpbb_privmsgs_rules', 'privmsgs_to' => 'phpbb_privmsgs_to', 'profile_fields' => 'phpbb_profile_fields', 'profile_fields_data' => 'phpbb_profile_fields_data', 'profile_fields_lang' => 'phpbb_profile_fields_lang', 'profile_lang' => 'phpbb_profile_lang', 'ranks' => 'phpbb_ranks', 'reports' => 'phpbb_reports', 'reports_reasons' => 'phpbb_reports_reasons', 'search_results' => 'phpbb_search_results', 'search_wordlist' => 'phpbb_search_wordlist', 'search_wordmatch' => 'phpbb_search_wordmatch', 'sessions' => 'phpbb_sessions', 'sessions_keys' => 'phpbb_sessions_keys', 'sitelist' => 'phpbb_sitelist', 'smilies' => 'phpbb_smilies', 'sphinx' => 'phpbb_sphinx', 'styles' => 'phpbb_styles', 'styles_template' => 'phpbb_styles_template', 'styles_template_data' => 'phpbb_styles_template_data', 'styles_theme' => 'phpbb_styles_theme', 'styles_imageset' => 'phpbb_styles_imageset', 'styles_imageset_data' => 'phpbb_styles_imageset_data', 'teampage' => 'phpbb_teampage', 'topics' => 'phpbb_topics', 'topics_posted' => 'phpbb_topics_posted', 'topics_track' => 'phpbb_topics_track', 'topics_watch' => 'phpbb_topics_watch', 'user_group' => 'phpbb_user_group', 'user_notifications' => 'phpbb_user_notifications', 'users' => 'phpbb_users', 'warnings' => 'phpbb_warnings', 'words' => 'phpbb_words', 'zebra' => 'phpbb_zebra'));
    }

    /**
     * Gets the public 'david63.privacypolicy.acp.edit.controller' shared service.
     *
     * @return \david63\privacypolicy\controller\acp_edit_controller
     */
    protected function getDavid63_Privacypolicy_Acp_Edit_ControllerService()
    {
        return $this->services['david63.privacypolicy.acp.edit.controller'] = new \david63\privacypolicy\controller\acp_edit_controller($this->get('config'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('language'), $this->get('log'), $this->get('dbal.conn'), './', 'php', $this->get('david63.privacypolicy.core.privacypolicy_lang'), $this->get('david63.privacypolicy.core.privacypolicy'), 'phpbb_privacy_lang', $this->get('david63.privacypolicy.core.functions'));
    }

    /**
     * Gets the public 'david63.privacypolicy.acp.manage.controller' shared service.
     *
     * @return \david63\privacypolicy\controller\acp_manage_controller
     */
    protected function getDavid63_Privacypolicy_Acp_Manage_ControllerService()
    {
        return $this->services['david63.privacypolicy.acp.manage.controller'] = new \david63\privacypolicy\controller\acp_manage_controller($this->get('config'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('language'), $this->get('log'), $this->get('dbal.conn'), $this->get('david63.privacypolicy.core.privacypolicy'), $this->get('david63.privacypolicy.core.functions'), array('acl_groups' => 'phpbb_acl_groups', 'acl_options' => 'phpbb_acl_options', 'acl_roles_data' => 'phpbb_acl_roles_data', 'acl_roles' => 'phpbb_acl_roles', 'acl_users' => 'phpbb_acl_users', 'attachments' => 'phpbb_attachments', 'banlist' => 'phpbb_banlist', 'bbcodes' => 'phpbb_bbcodes', 'bookmarks' => 'phpbb_bookmarks', 'bots' => 'phpbb_bots', 'config' => 'phpbb_config', 'config_text' => 'phpbb_config_text', 'confirm' => 'phpbb_confirm', 'disallow' => 'phpbb_disallow', 'drafts' => 'phpbb_drafts', 'ext' => 'phpbb_ext', 'extesnions' => 'phpbb_extesnions', 'extension_groups\'' => 'phpbb_extension_groups', 'forums' => 'phpbb_forums', 'forums_access' => 'phpbb_forums_access', 'forums_track' => 'phpbb_forums_track', 'forums_watch' => 'phpbb_forums_watch', 'groups' => 'phpbb_groups', 'icons' => 'phpbb_icons', 'lang' => 'phpbb_lang', 'log' => 'phpbb_log', 'login_attempts' => 'phpbb_login_attempts', 'migrations' => 'phpbb_migrations', 'moderator_cache' => 'phpbb_moderator_cache', 'modules' => 'phpbb_modules', 'notification_types' => 'phpbb_notification_types', 'notifications' => 'phpbb_notifications', 'poll_options' => 'phpbb_poll_options', 'poll_votes' => 'phpbb_poll_votes', 'posts' => 'phpbb_posts', 'privmsgs' => 'phpbb_privmsgs', 'privmsgs_folder' => 'phpbb_privmsgs_folder', 'privmsgs_rules' => 'phpbb_privmsgs_rules', 'privmsgs_to' => 'phpbb_privmsgs_to', 'profile_fields' => 'phpbb_profile_fields', 'profile_fields_data' => 'phpbb_profile_fields_data', 'profile_fields_lang' => 'phpbb_profile_fields_lang', 'profile_lang' => 'phpbb_profile_lang', 'ranks' => 'phpbb_ranks', 'reports' => 'phpbb_reports', 'reports_reasons' => 'phpbb_reports_reasons', 'search_results' => 'phpbb_search_results', 'search_wordlist' => 'phpbb_search_wordlist', 'search_wordmatch' => 'phpbb_search_wordmatch', 'sessions' => 'phpbb_sessions', 'sessions_keys' => 'phpbb_sessions_keys', 'sitelist' => 'phpbb_sitelist', 'smilies' => 'phpbb_smilies', 'sphinx' => 'phpbb_sphinx', 'styles' => 'phpbb_styles', 'styles_template' => 'phpbb_styles_template', 'styles_template_data' => 'phpbb_styles_template_data', 'styles_theme' => 'phpbb_styles_theme', 'styles_imageset' => 'phpbb_styles_imageset', 'styles_imageset_data' => 'phpbb_styles_imageset_data', 'teampage' => 'phpbb_teampage', 'topics' => 'phpbb_topics', 'topics_posted' => 'phpbb_topics_posted', 'topics_track' => 'phpbb_topics_track', 'topics_watch' => 'phpbb_topics_watch', 'user_group' => 'phpbb_user_group', 'user_notifications' => 'phpbb_user_notifications', 'users' => 'phpbb_users', 'warnings' => 'phpbb_warnings', 'words' => 'phpbb_words', 'zebra' => 'phpbb_zebra'));
    }

    /**
     * Gets the public 'david63.privacypolicy.autogroups.type.ppaccept' service.
     *
     * @return \david63\privacypolicy\conditions\type\ppaccept
     */
    protected function getDavid63_Privacypolicy_Autogroups_Type_PpacceptService()
    {
        return new \david63\privacypolicy\conditions\type\ppaccept($this, $this->get('dbal.conn'), $this->get('language'), 'phpbb_autogroups_rules', 'phpbb_autogroups_types', './', 'php');
    }

    /**
     * Gets the public 'david63.privacypolicy.core.functions' shared service.
     *
     * @return \david63\privacypolicy\core\functions
     */
    protected function getDavid63_Privacypolicy_Core_FunctionsService()
    {
        return $this->services['david63.privacypolicy.core.functions'] = new \david63\privacypolicy\core\functions($this->get('ext.manager'));
    }

    /**
     * Gets the public 'david63.privacypolicy.core.privacypolicy' shared service.
     *
     * @return \david63\privacypolicy\core\privacypolicy
     */
    protected function getDavid63_Privacypolicy_Core_PrivacypolicyService()
    {
        return $this->services['david63.privacypolicy.core.privacypolicy'] = new \david63\privacypolicy\core\privacypolicy($this->get('config'), $this->get('template'), $this->get('user'), $this->get('language'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('profilefields.type_collection'), './', 'php', $this->get('david63.privacypolicy.core.functions'), array('acl_groups' => 'phpbb_acl_groups', 'acl_options' => 'phpbb_acl_options', 'acl_roles_data' => 'phpbb_acl_roles_data', 'acl_roles' => 'phpbb_acl_roles', 'acl_users' => 'phpbb_acl_users', 'attachments' => 'phpbb_attachments', 'banlist' => 'phpbb_banlist', 'bbcodes' => 'phpbb_bbcodes', 'bookmarks' => 'phpbb_bookmarks', 'bots' => 'phpbb_bots', 'config' => 'phpbb_config', 'config_text' => 'phpbb_config_text', 'confirm' => 'phpbb_confirm', 'disallow' => 'phpbb_disallow', 'drafts' => 'phpbb_drafts', 'ext' => 'phpbb_ext', 'extesnions' => 'phpbb_extesnions', 'extension_groups\'' => 'phpbb_extension_groups', 'forums' => 'phpbb_forums', 'forums_access' => 'phpbb_forums_access', 'forums_track' => 'phpbb_forums_track', 'forums_watch' => 'phpbb_forums_watch', 'groups' => 'phpbb_groups', 'icons' => 'phpbb_icons', 'lang' => 'phpbb_lang', 'log' => 'phpbb_log', 'login_attempts' => 'phpbb_login_attempts', 'migrations' => 'phpbb_migrations', 'moderator_cache' => 'phpbb_moderator_cache', 'modules' => 'phpbb_modules', 'notification_types' => 'phpbb_notification_types', 'notifications' => 'phpbb_notifications', 'poll_options' => 'phpbb_poll_options', 'poll_votes' => 'phpbb_poll_votes', 'posts' => 'phpbb_posts', 'privmsgs' => 'phpbb_privmsgs', 'privmsgs_folder' => 'phpbb_privmsgs_folder', 'privmsgs_rules' => 'phpbb_privmsgs_rules', 'privmsgs_to' => 'phpbb_privmsgs_to', 'profile_fields' => 'phpbb_profile_fields', 'profile_fields_data' => 'phpbb_profile_fields_data', 'profile_fields_lang' => 'phpbb_profile_fields_lang', 'profile_lang' => 'phpbb_profile_lang', 'ranks' => 'phpbb_ranks', 'reports' => 'phpbb_reports', 'reports_reasons' => 'phpbb_reports_reasons', 'search_results' => 'phpbb_search_results', 'search_wordlist' => 'phpbb_search_wordlist', 'search_wordmatch' => 'phpbb_search_wordmatch', 'sessions' => 'phpbb_sessions', 'sessions_keys' => 'phpbb_sessions_keys', 'sitelist' => 'phpbb_sitelist', 'smilies' => 'phpbb_smilies', 'sphinx' => 'phpbb_sphinx', 'styles' => 'phpbb_styles', 'styles_template' => 'phpbb_styles_template', 'styles_template_data' => 'phpbb_styles_template_data', 'styles_theme' => 'phpbb_styles_theme', 'styles_imageset' => 'phpbb_styles_imageset', 'styles_imageset_data' => 'phpbb_styles_imageset_data', 'teampage' => 'phpbb_teampage', 'topics' => 'phpbb_topics', 'topics_posted' => 'phpbb_topics_posted', 'topics_track' => 'phpbb_topics_track', 'topics_watch' => 'phpbb_topics_watch', 'user_group' => 'phpbb_user_group', 'user_notifications' => 'phpbb_user_notifications', 'users' => 'phpbb_users', 'warnings' => 'phpbb_warnings', 'words' => 'phpbb_words', 'zebra' => 'phpbb_zebra'), NULL);
    }

    /**
     * Gets the public 'david63.privacypolicy.core.privacypolicy_lang' shared service.
     *
     * @return \david63\privacypolicy\core\privacypolicy_lang
     */
    protected function getDavid63_Privacypolicy_Core_PrivacypolicyLangService()
    {
        return $this->services['david63.privacypolicy.core.privacypolicy_lang'] = new \david63\privacypolicy\core\privacypolicy_lang($this->get('config'), $this->get('user'), $this->get('language'), $this->get('dbal.conn'), $this->get('template'), 'phpbb_privacy_lang', array('acl_groups' => 'phpbb_acl_groups', 'acl_options' => 'phpbb_acl_options', 'acl_roles_data' => 'phpbb_acl_roles_data', 'acl_roles' => 'phpbb_acl_roles', 'acl_users' => 'phpbb_acl_users', 'attachments' => 'phpbb_attachments', 'banlist' => 'phpbb_banlist', 'bbcodes' => 'phpbb_bbcodes', 'bookmarks' => 'phpbb_bookmarks', 'bots' => 'phpbb_bots', 'config' => 'phpbb_config', 'config_text' => 'phpbb_config_text', 'confirm' => 'phpbb_confirm', 'disallow' => 'phpbb_disallow', 'drafts' => 'phpbb_drafts', 'ext' => 'phpbb_ext', 'extesnions' => 'phpbb_extesnions', 'extension_groups\'' => 'phpbb_extension_groups', 'forums' => 'phpbb_forums', 'forums_access' => 'phpbb_forums_access', 'forums_track' => 'phpbb_forums_track', 'forums_watch' => 'phpbb_forums_watch', 'groups' => 'phpbb_groups', 'icons' => 'phpbb_icons', 'lang' => 'phpbb_lang', 'log' => 'phpbb_log', 'login_attempts' => 'phpbb_login_attempts', 'migrations' => 'phpbb_migrations', 'moderator_cache' => 'phpbb_moderator_cache', 'modules' => 'phpbb_modules', 'notification_types' => 'phpbb_notification_types', 'notifications' => 'phpbb_notifications', 'poll_options' => 'phpbb_poll_options', 'poll_votes' => 'phpbb_poll_votes', 'posts' => 'phpbb_posts', 'privmsgs' => 'phpbb_privmsgs', 'privmsgs_folder' => 'phpbb_privmsgs_folder', 'privmsgs_rules' => 'phpbb_privmsgs_rules', 'privmsgs_to' => 'phpbb_privmsgs_to', 'profile_fields' => 'phpbb_profile_fields', 'profile_fields_data' => 'phpbb_profile_fields_data', 'profile_fields_lang' => 'phpbb_profile_fields_lang', 'profile_lang' => 'phpbb_profile_lang', 'ranks' => 'phpbb_ranks', 'reports' => 'phpbb_reports', 'reports_reasons' => 'phpbb_reports_reasons', 'search_results' => 'phpbb_search_results', 'search_wordlist' => 'phpbb_search_wordlist', 'search_wordmatch' => 'phpbb_search_wordmatch', 'sessions' => 'phpbb_sessions', 'sessions_keys' => 'phpbb_sessions_keys', 'sitelist' => 'phpbb_sitelist', 'smilies' => 'phpbb_smilies', 'sphinx' => 'phpbb_sphinx', 'styles' => 'phpbb_styles', 'styles_template' => 'phpbb_styles_template', 'styles_template_data' => 'phpbb_styles_template_data', 'styles_theme' => 'phpbb_styles_theme', 'styles_imageset' => 'phpbb_styles_imageset', 'styles_imageset_data' => 'phpbb_styles_imageset_data', 'teampage' => 'phpbb_teampage', 'topics' => 'phpbb_topics', 'topics_posted' => 'phpbb_topics_posted', 'topics_track' => 'phpbb_topics_track', 'topics_watch' => 'phpbb_topics_watch', 'user_group' => 'phpbb_user_group', 'user_notifications' => 'phpbb_user_notifications', 'users' => 'phpbb_users', 'warnings' => 'phpbb_warnings', 'words' => 'phpbb_words', 'zebra' => 'phpbb_zebra'));
    }

    /**
     * Gets the public 'david63.privacypolicy.listener' shared service.
     *
     * @return \david63\privacypolicy\event\listener
     */
    protected function getDavid63_Privacypolicy_ListenerService()
    {
        return $this->services['david63.privacypolicy.listener'] = new \david63\privacypolicy\event\listener($this->get('config'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('log'), $this->get('controller.helper'), $this->get('request'), $this->get('language'), $this->get('david63.privacypolicy.core.privacypolicy_lang'), $this->get('david63.privacypolicy.core.privacypolicy'), $this->get('david63.privacypolicy.core.functions'));
    }

    /**
     * Gets the public 'david63.privacypolicy.main.controller' shared service.
     *
     * @return \david63\privacypolicy\controller\main_controller
     */
    protected function getDavid63_Privacypolicy_Main_ControllerService()
    {
        return $this->services['david63.privacypolicy.main.controller'] = new \david63\privacypolicy\controller\main_controller($this->get('user'), $this->get('request'), $this->get('controller.helper'), $this->get('dbal.conn'), $this->get('template'), $this->get('config'), $this->get('language'), './', 'php', $this->get('david63.privacypolicy.core.privacypolicy_lang'), $this->get('david63.privacypolicy.core.privacypolicy'), $this->get('david63.privacypolicy.core.functions'), array('acl_groups' => 'phpbb_acl_groups', 'acl_options' => 'phpbb_acl_options', 'acl_roles_data' => 'phpbb_acl_roles_data', 'acl_roles' => 'phpbb_acl_roles', 'acl_users' => 'phpbb_acl_users', 'attachments' => 'phpbb_attachments', 'banlist' => 'phpbb_banlist', 'bbcodes' => 'phpbb_bbcodes', 'bookmarks' => 'phpbb_bookmarks', 'bots' => 'phpbb_bots', 'config' => 'phpbb_config', 'config_text' => 'phpbb_config_text', 'confirm' => 'phpbb_confirm', 'disallow' => 'phpbb_disallow', 'drafts' => 'phpbb_drafts', 'ext' => 'phpbb_ext', 'extesnions' => 'phpbb_extesnions', 'extension_groups\'' => 'phpbb_extension_groups', 'forums' => 'phpbb_forums', 'forums_access' => 'phpbb_forums_access', 'forums_track' => 'phpbb_forums_track', 'forums_watch' => 'phpbb_forums_watch', 'groups' => 'phpbb_groups', 'icons' => 'phpbb_icons', 'lang' => 'phpbb_lang', 'log' => 'phpbb_log', 'login_attempts' => 'phpbb_login_attempts', 'migrations' => 'phpbb_migrations', 'moderator_cache' => 'phpbb_moderator_cache', 'modules' => 'phpbb_modules', 'notification_types' => 'phpbb_notification_types', 'notifications' => 'phpbb_notifications', 'poll_options' => 'phpbb_poll_options', 'poll_votes' => 'phpbb_poll_votes', 'posts' => 'phpbb_posts', 'privmsgs' => 'phpbb_privmsgs', 'privmsgs_folder' => 'phpbb_privmsgs_folder', 'privmsgs_rules' => 'phpbb_privmsgs_rules', 'privmsgs_to' => 'phpbb_privmsgs_to', 'profile_fields' => 'phpbb_profile_fields', 'profile_fields_data' => 'phpbb_profile_fields_data', 'profile_fields_lang' => 'phpbb_profile_fields_lang', 'profile_lang' => 'phpbb_profile_lang', 'ranks' => 'phpbb_ranks', 'reports' => 'phpbb_reports', 'reports_reasons' => 'phpbb_reports_reasons', 'search_results' => 'phpbb_search_results', 'search_wordlist' => 'phpbb_search_wordlist', 'search_wordmatch' => 'phpbb_search_wordmatch', 'sessions' => 'phpbb_sessions', 'sessions_keys' => 'phpbb_sessions_keys', 'sitelist' => 'phpbb_sitelist', 'smilies' => 'phpbb_smilies', 'sphinx' => 'phpbb_sphinx', 'styles' => 'phpbb_styles', 'styles_template' => 'phpbb_styles_template', 'styles_template_data' => 'phpbb_styles_template_data', 'styles_theme' => 'phpbb_styles_theme', 'styles_imageset' => 'phpbb_styles_imageset', 'styles_imageset_data' => 'phpbb_styles_imageset_data', 'teampage' => 'phpbb_teampage', 'topics' => 'phpbb_topics', 'topics_posted' => 'phpbb_topics_posted', 'topics_track' => 'phpbb_topics_track', 'topics_watch' => 'phpbb_topics_watch', 'user_group' => 'phpbb_user_group', 'user_notifications' => 'phpbb_user_notifications', 'users' => 'phpbb_users', 'warnings' => 'phpbb_warnings', 'words' => 'phpbb_words', 'zebra' => 'phpbb_zebra'));
    }

    /**
     * Gets the public 'david63.privacypolicy.ucp.controller' shared service.
     *
     * @return \david63\privacypolicy\controller\ucp_controller
     */
    protected function getDavid63_Privacypolicy_Ucp_ControllerService()
    {
        return $this->services['david63.privacypolicy.ucp.controller'] = new \david63\privacypolicy\controller\ucp_controller($this->get('config'), $this->get('user'), $this->get('request'), $this->get('language'), $this->get('template'), $this->get('david63.privacypolicy.core.privacypolicy'), $this->get('david63.privacypolicy.core.functions'));
    }
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('alfredoramos.simplespoiler.listener', 'alfredoramos\\simplespoiler\\event\\listener');
        $instance->addSubscriberService('david63.privacypolicy.listener', 'david63\\privacypolicy\\event\\listener');
        $instance->addSubscriberService('hifikabin.amazonaffiliate.listener', 'hifikabin\\amazonaffiliate\\event\\listener');
        $instance->addSubscriberService('hjw.calendar.listener', 'hjw\\calendar\\event\\main_listener');
        $instance->addSubscriberService('javiexin.chgposttime.listener', 'javiexin\\chgposttime\\event\\listener');
        $instance->addSubscriberService('jv.deletemyregistration.listener', 'jv\\deletemyregistration\\event\\listener');
        $instance->addSubscriberService('paul999.ajaxshoutbox.listener', 'paul999\\ajaxshoutbox\\event\\shoutbox_listener');
        ...
        $instance->addSubscriberService('phpbbmodders.banhammer.listener', 'phpbbmodders\\banhammer\\event\\banhammer_listener');
    ...
    /**
     * Gets the public 'ger.feedpostbot.classes.driver' shared service.
     *
     * @return \ger\feedpostbot\classes\driver
     */
    protected function getGer_Feedpostbot_Classes_DriverService()
    {
        return $this->services['ger.feedpostbot.classes.driver'] = new \ger\feedpostbot\classes\driver($this->get('config'), $this->get('config_text'), $this->get('user'), $this->get('language'), $this->get('auth'), $this->get('dbal.conn'), $this->get('log'), './', 'php', $this->get('dispatcher'));
    }

    /**
     * Gets the public 'ger.feedpostbot.cron.task.feedpostbot_cron' shared service.
     *
     * @return \ger\feedpostbot\cron\task\feedpostbot_cron
     */
    protected function getGer_Feedpostbot_Cron_Task_FeedpostbotCronService()
    {
        $this->services['ger.feedpostbot.cron.task.feedpostbot_cron'] = $instance = new \ger\feedpostbot\cron\task\feedpostbot_cron($this->get('config'), $this->get('ger.feedpostbot.classes.driver'));

        $instance->set_name('cron.task.feedpostbot_cron');
    ...
    /**
     * Gets the public 'hifikabin.amazonaffiliate.listener' shared service.
     *
     * @return \hifikabin\amazonaffiliate\event\listener
     */
    protected function getHifikabin_Amazonaffiliate_ListenerService()
    {
        return $this->services['hifikabin.amazonaffiliate.listener'] = new \hifikabin\amazonaffiliate\event\listener($this->get('template'), $this->get('config'));
    }

    /**
     * Gets the public 'hjw.calendar.controller' shared service.
     *
     * @return \hjw\calendar\controller\main
     */
    protected function getHjw_Calendar_ControllerService()
    {
        return $this->services['hjw.calendar.controller'] = new \hjw\calendar\controller\main($this, $this->get('config'), $this->get('dbal.conn'), $this->get('controller.helper'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('language'), $this->get('request'), $this->get('dispatcher'), 'phpbb_', './', '.php');
    }

    /**
     * Gets the public 'hjw.calendar.listener' shared service.
     *
     * @return \hjw\calendar\event\main_listener
     */
    protected function getHjw_Calendar_ListenerService()
    {
        return $this->services['hjw.calendar.listener'] = new \hjw\calendar\event\main_listener($this, $this->get('config'), $this->get('dbal.conn'), $this->get('controller.helper'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('language'), $this->get('request'), $this->get('dispatcher'), 'phpbb_', './', '.php');
    }
    ...
    /**
     * Gets the public 'javiexin.chgposttime.listener' shared service.
     *
     * @return \javiexin\chgposttime\event\listener
     */
    protected function getJaviexin_Chgposttime_ListenerService()
    {
        return $this->services['javiexin.chgposttime.listener'] = new \javiexin\chgposttime\event\listener($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('request'), $this, './', 'php');
    }

    /**
     * Gets the public 'jv.deletemyregistration.listener' shared service.
     *
     * @return \jv\deletemyregistration\event\listener
     */
    protected function getJv_Deletemyregistration_ListenerService()
    {
        return $this->services['jv.deletemyregistration.listener'] = new \jv\deletemyregistration\event\listener();
    }
    ...
    /**
     * Gets the public 'paul999.ajaxshoutbox.controller' shared service.
     *
     * @return \paul999\ajaxshoutbox\controller\main_controller
     */
    protected function getPaul999_Ajaxshoutbox_ControllerService()
    {
        return $this->services['paul999.ajaxshoutbox.controller'] = new \paul999\ajaxshoutbox\controller\main_controller($this->get('config'), $this->get('controller.helper'), $this->get('template'), $this->get('user'), $this->get('request'), $this->get('dbal.conn'), $this->get('auth'), $this->get('paul999.ajaxshoutbox.delete'), './', 'php', 'phpbb_ajax_shoutbox', 'phpbb_users');
    }

    /**
     * Gets the public 'paul999.ajaxshoutbox.cron.task.shoutbox_prune' shared service.
     *
     * @return \paul999\ajaxshoutbox\cron\shoutbox_prune
     */
    protected function getPaul999_Ajaxshoutbox_Cron_Task_ShoutboxPruneService()
    {
        $this->services['paul999.ajaxshoutbox.cron.task.shoutbox_prune'] = $instance = new \paul999\ajaxshoutbox\cron\shoutbox_prune($this->get('config'), $this->get('dbal.conn'), $this->get('log'), $this->get('user'), 'phpbb_ajax_shoutbox');

        $instance->set_name('cron.task.shoutbox_prune');

        return $instance;
    }

    /**
     * Gets the public 'paul999.ajaxshoutbox.delete' shared service.
     *
     * @return \paul999\ajaxshoutbox\actions\delete
     */
    protected function getPaul999_Ajaxshoutbox_DeleteService()
    {
        return $this->services['paul999.ajaxshoutbox.delete'] = new \paul999\ajaxshoutbox\actions\delete($this->get('config'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('user'), 'phpbb_ajax_shoutbox');
    }

    /**
     * Gets the public 'paul999.ajaxshoutbox.listener' shared service.
     *
     * @return \paul999\ajaxshoutbox\event\shoutbox_listener
     */
    protected function getPaul999_Ajaxshoutbox_ListenerService()
    {
        return $this->services['paul999.ajaxshoutbox.listener'] = new \paul999\ajaxshoutbox\event\shoutbox_listener($this->get('config'), $this->get('user'), $this->get('template'), $this->get('controller.helper'), $this->get('auth'), $this->get('request'));
    }
    ...
    /**
     * Gets the public 'phpbbmodders.banhammer.admin.controller' shared service.
     *
    ...
    {
        return $this->services['phpbbmodders.banhammer.admin.controller'] = new \phpbbmodders\banhammer\controller\admin_controller($this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('log'), $this->get('phpbbmodders.banhammer.core.bantime'));
    }

    /**
     * Gets the public 'phpbbmodders.banhammer.core.bantime' shared service.
     *
     * @return \phpbbmodders\banhammer\core\bantime
     */
    protected function getPhpbbmodders_Banhammer_Core_BantimeService()
    {
        return $this->services['phpbbmodders.banhammer.core.bantime'] = new \phpbbmodders\banhammer\core\bantime($this->get('user'));
    }

    /**
     * Gets the public 'phpbbmodders.banhammer.listener' shared service.
     *
     * @return \phpbbmodders\banhammer\event\banhammer_listener
     */
    protected function getPhpbbmodders_Banhammer_ListenerService()
    {
        return $this->services['phpbbmodders.banhammer.listener'] = new \phpbbmodders\banhammer\event\banhammer_listener($this->get('auth'), $this->get('cache.driver'), $this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('phpbbmodders.banhammer.core.bantime'), './', 'php');
    }
    ...
    /**
     * Gets the public 'senky.removesubjectfromreplies.listener' shared service.
     *
     * @return \senky\removesubjectfromreplies\event\listener
     */
    protected function getSenky_Removesubjectfromreplies_ListenerService()
    {
        return $this->services['senky.removesubjectfromreplies.listener'] = new \senky\removesubjectfromreplies\event\listener($this->get('user'), 'phpbb_topics');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002b461f40000000003eecd197(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'david63.privacypolicy.tables.privacy_lang' => 'phpbb_privacy_lang',
            'tables' => array(
                ...
                'profile_fields_lang' => 'phpbb_profile_fields_lang',
                'profile_lang' => 'phpbb_profile_lang',
                'ranks' => 'phpbb_ranks',
            ...
            'tables.calendar' => 'phpbb_calendar',
            'tables.calendar_participants' => 'phpbb_calendar_participants',
            'tables.calendar_event' => 'phpbb_calendar_event',
            'tables.calendar_event_list' => 'phpbb_calendar_event_list',
            'tables.calendar_special_days' => 'phpbb_calendar_special_days',
            'tables.calendar_forums' => 'phpbb_calendar_forums',
            'tables.calendar_config' => 'phpbb_calendar_config',
            'tables.footb_matches' => 'phpbb_footb_matches',
            'tables.footb_teams' => 'phpbb_footb_teams',
            'paul999.ajaxshoutbox.tables.ajaxshoutbox' => 'phpbb_ajax_shoutbox',
...
class phpbbtemplatetwiglexer_000000002b461f40000000003eecd197 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder60b739f9f0cd1313635192 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer60b739f9f0cd9411351656 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties60b739f9f0cb4187533417 = array(
    ...
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, 'set_environment', array('env' => $env), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;

        return $this->valueHolder60b739f9f0cd1313635192->set_environment($env);
    }
    ...
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;

        return $this->valueHolder60b739f9f0cd1313635192->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;

        return $this->valueHolder60b739f9f0cd1313635192->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer60b739f9f0cd9411351656 = $initializer;
    }
    ...
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, '__get', array('name' => $name), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;

        if (isset(self::$publicProperties60b739f9f0cb4187533417[$name])) {
            return $this->valueHolder60b739f9f0cd1313635192->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder60b739f9f0cd1313635192;
    ...
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;
    ...
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, '__isset', array('name' => $name), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;
    ...
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, '__unset', array('name' => $name), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;
    ...
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, '__clone', array(), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;

        $this->valueHolder60b739f9f0cd1313635192 = clone $this->valueHolder60b739f9f0cd1313635192;
    }

    public function __sleep()
    {
        $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, '__sleep', array(), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;

        return array('valueHolder60b739f9f0cd1313635192');
    }
    ...
    {
        return $this->initializer60b739f9f0cd9411351656;
    }
    ...
    {
        return $this->initializer60b739f9f0cd9411351656 && ($this->initializer60b739f9f0cd9411351656->__invoke($valueHolder60b739f9f0cd1313635192, $this, 'initializeProxy', array(), $this->initializer60b739f9f0cd9411351656) || 1) && $this->valueHolder60b739f9f0cd1313635192 = $valueHolder60b739f9f0cd1313635192;
    }
    ...
    {
        return null !== $this->valueHolder60b739f9f0cd1313635192;
    }
    ...
    {
        return $this->valueHolder60b739f9f0cd1313635192;
    }
